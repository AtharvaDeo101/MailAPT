...
// Replace this with your real base64 image data URI
...
const GlassButton = React.forwardRef<HTMLButtonElement, GlassButtonProps>(
  ({ className, children, size, contentClassName, glassColor, type = "button", ...props }, ref) => {
    ...
    return (
      <>
        ...
        >
          ...
          <span
            className={cn(
              "btn-liquid-text relative z-10 flex w-full select-none items-center justify-center gap-[inherit]",
              contentClassName
            )}
          >
            {children}
...
export function FlowButton({
  ...
  return (
    ...
    >
      ...
      <span className="absolute left-1/2 top-1/2 h-4 w-4 -translate-x-1/2 -translate-y-1/2 rounded-full bg-[#111111] opacity-0 transition-all duration-[800ms] ease-[cubic-bezier(0.19,1,0.22,1)] group-hover:h-[220px] group-hover:w-[220px] group-hover:opacity-100" />
